...
QT_MOC_LITERAL(5, 26, 9), // "logged_in"
QT_MOC_LITERAL(6, 36, 11), // "std::string"
QT_MOC_LITERAL(7, 48, 4) // "user"

    },
    "Gui\0send_symbol\0\0Symbol\0s\0logged_in\0"
    "std::string\0user"
};
...
void Gui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_symbol((*reinterpret_cast< Symbol(*)>(_a[1]))); break;
        case 1: _t->logged_in((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Gui::*)(Symbol );
...
// SIGNAL 0
void Gui::send_symbol(Symbol _t1)
{
