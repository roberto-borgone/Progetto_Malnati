...
void ProjectsPopUp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ProjectsPopUp *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ProjectsPopUp::*)(std::string );
...
QT_INIT_METAOBJECT const QMetaObject ProjectsPopUp::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ProjectsPopUp.data,
    qt_meta_data_ProjectsPopUp,
    qt_static_metacall,
    nullptr,
    nullptr
} };
